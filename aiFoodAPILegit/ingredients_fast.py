...
def display(mcros, list_to_display, target_mcros):
...
def feedback(arr, initial_list, mcros, target_mcros):
...
list_to_display, mcros = main(target_mcros)
display(list_to_display, mcros, target_mcros)
...
while True:
    ...
    list_to_display = feedback(arr, list_to_display, mcros, target_mcros)
    display(mcros, list_to_display, target_mcros)

    

print(label_only = [x[0] for x in list_to_display])
